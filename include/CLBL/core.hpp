...
#include <CLBL/dispatch/function_object.hpp>
#include <CLBL/wrapper/partial_wrapper.hpp>
#include <CLBL/fwd/binding_wrapper.hpp>
#include <CLBL/bind/binding_wrapper.hpp>
#include <CLBL/fwd/callable_wrapper.hpp>
