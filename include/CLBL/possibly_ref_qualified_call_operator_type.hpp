...
namespace clbl {
    ...
    namespace detail {
        ...
        struct possibly_ref_qualified_call_operator
        {
            ...
            using reference_pmf_cast = typename PmfDispatch::template add_qualifiers<QFlags>;

            using normal_pmf_dispatch = typename PmfDispatch::remove_reference;
            using normal_pmf_cast = typename normal_pmf_dispatch::template add_qualifiers<flags_without_reference>;
