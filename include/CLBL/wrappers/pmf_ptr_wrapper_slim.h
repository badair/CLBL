...
namespace clbl {
    ...
    */
    ...
    template<typename Creator, qualify_flags CvFlags, typename UnderlyingType, typename TPtr,
        typename TMemberFnPtr, TMemberFnPtr Pmf, typename Return, typename... Args>
    struct pmf_ptr_wrapper_slim<Creator, CvFlags, UnderlyingType, TPtr,
        TMemberFnPtr, Pmf, Return(std::remove_cv_t<UnderlyingType>::*)(Args...)> {
        ...
        using apply_cv = pmf_ptr_wrapper_slim<Creator, CvFlags | Flags, UnderlyingType, TPtr, TMemberFnPtr, Pmf, decayed_member_fn_ptr>;
